# LCIMS Docker Setup Demo on your Local Computer

This repository contains the steps required to run the **Limbe City Information Management System (LCIMS)** using Docker Compose configuration. It includes the `backend`, `frontend`, and `PostgreSQL` database services, all built from pre-built Docker images.
...
- **Image**: `<docker-hub-username>/lcimsbackend:production`
- **Port**: `3000`
...
- **Image**: `<docker-hub-username>/lcimsdb:production`
- **Health Check**:
...
- **Image**: `<docker-hub-username>/frontend:production`
